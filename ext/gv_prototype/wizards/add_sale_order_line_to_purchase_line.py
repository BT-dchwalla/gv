...
class AddSOLtoPOL(models.TransientModel):
    _name = 'gv_prototype.add_sol_to_pol'
    ...
    details_ids = fields.One2many('gv_prototype.add_sol_to_pol_details', 'add_sol_to_pol_id', 'Details')
...
class Details(models.TransientModel):
    _name = 'gv_prototype.add_sol_to_pol_details'

    add_sol_to_pol_id = fields.Many2one('gv_prototype.add_sol_to_pol', 'Parent')
